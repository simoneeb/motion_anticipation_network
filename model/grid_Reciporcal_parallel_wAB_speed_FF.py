...
df.to_csv(f'/Users/simoneebert/Documents/Simulations/motion_anticipation_network/{net_name}/anticipation_data_wAB.csv')
dfresRG.to_csv(f'/Users/simoneebert/Documents/Simulations/motion_anticipation_network/{net_name}/responses_RG_wAB.csv')
dfresRB.to_csv(f'/Users/simoneebert/Documents/Simulations/motion_anticipation_network/{net_name}/responses_RB_wAB.csv')

stop = time.time()
params = X[-1][-1]
with open(f'/Users/simoneebert/Documents/Simulations/motion_anticipation_network/{net_name}/params_grid_wAB', 'wb') as handle:
