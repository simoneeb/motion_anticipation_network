...
BC_cells= np.asarray(BC_cells)-CELL_GC
...
ax[4].set_title('BC occupancy', loc = 'left')
ax[5].set_title('BC response', loc = 'left')
ax[6].set_title('BC response weighted', loc = 'left')
ax[7].set_title('GC voltage', loc = 'left')
...
for i,c in enumerate(BC_cells):
    ...
    ax[4].plot(out['OB'][c,:], alpha = 0.5,linewidth = 1, color = 'k')
    ax[5].plot(out['RB'][c,:], alpha = 0.5,linewidth = 1, color = 'k')


    r =  out['RB'][c] *BC_cells_weight[i] 

    ax[6].plot(r, alpha = 0.5,linewidth = 1, color = 'k')
...
for i,c in enumerate(BC_cells_short):
    ...
    ax[4].plot(out['OB'][c,:], alpha = 1, color = scalarMap_gaincontrol.to_rgba(BC_cells_weight_short[i]))
    ax[5].plot(out['RB'][c,:], alpha = 1, color = scalarMap_gaincontrol.to_rgba(BC_cells_weight_short[i]))

    r =  out['RB'][c] *BC_cells_weight_short[i] 

    ax[6].plot(r, alpha = 1,linewidth = 2,  color = scalarMap_gaincontrol.to_rgba(BC_cells_weight_short[i]))

ax[7].plot(out['VG'][:],alpha = 1, color = 'blue', linewidth = 2)
...
ax[0].plot(out['VG'][:],alpha = 1, color = 'blue', linewidth = 2)
ax[1].plot(out['NG'][:],alpha = 1, color = 'blue', linewidth = 2)
ax[2].plot(out['AG'][:],alpha = 1, color = 'blue', linewidth = 2)
ax[3].plot(out['GG'][:],alpha = 1, color = 'blue', linewidth = 2)
ax[4].plot(out['RG'][:],alpha = 1, color = 'blue', linewidth = 2)
...
fig,ax = plt.subplots(8, sharex = True, figsize = figsize)
...
ax[5].set_title('AC occupancy', loc = 'left')
ax[6].set_title('AC response weighted', loc = 'left')
ax[7].set_title('AC voltage', loc = 'left')
...
for i,c in enumerate(BC_cells):
    ...
    ax[4].plot(out['OA'][c,:], alpha = 0.5,linewidth = 1, color = 'k')
    ax[5].plot(out['RA'][c,:], alpha = 0.5,linewidth = 1, color = 'k')
...
for i,c in enumerate(BC_cells_short):
    ...
    ax[4].plot(out['OA'][c,:], alpha = 1, color = scalarMap_gaincontrol.to_rgba(BC_cells_weight_short[i]))
    ax[5].plot(out['RA'][c,:], alpha = 1, color = scalarMap_gaincontrol.to_rgba(BC_cells_weight_short[i]))
