...
for i,s in enumerate(speeds):
    ...
    plotter.plot_mean_GC(ax = ax,label = f'speed {s}',y = unit, color=cmap(i), linewidth = 5)
...
fig.savefig(f'{filepath}/{param}/plots/RG_speeds_mean_{unit}_{par}.png')


fig.savefig(f'{filepath}/{param}/{par}/RG_speeds_mean_{unit}_{par}.png')
