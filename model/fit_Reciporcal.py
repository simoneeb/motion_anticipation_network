...
s = 0.81
fp = f'/user/sebert/home/Documents/Simulations/motion/anticipation_1D/Reciporcal/GainControl_fitted/w_GC/w_GC_0/smooth_{s}'
with open(f'{fp}/params', 'rb') as handle:
    params = pickle.load(handle)   


# define parameter to be fitted 
paramis = ['wAB', 'wBA', 'tauA']

# give initial conditions
paramis_init = np.array([6,6,9])
x0 = np.log(paramis_init)
scales = np.array([10,10,0.01])
...
# save best params
with open(f'{fp}/params_opt_with_ACMDS_fitted', 'wb') as handle:
