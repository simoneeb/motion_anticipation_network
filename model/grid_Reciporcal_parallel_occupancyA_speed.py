...
def run(val,si):
    ...
    params = make_params(param_names = ['speed','krecA','krelA','betaA'], param_vals=[si,krec,krel,beta])
...
df.to_csv(f'/user/sebert/home/Documents/Simulations/motion/anticipation_1D/Reciporcal/{net_name}/anticipation_data_nA_long2.csv')
dfresRG.to_csv(f'/user/sebert/home/Documents/Simulations/motion/anticipation_1D/Reciporcal/{net_name}/responses_RG_nA_long2.csv')
dfresRB.to_csv(f'/user/sebert/home/Documents/Simulations/motion/anticipation_1D/Reciporcal/{net_name}/responses_RB_nA_long2.csv')
